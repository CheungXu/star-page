...
- `20260527/frontend-homepage-ui-redesign.md`：首页 UI 重构记录，第一轮按设计反馈引入设计 token 体系、重构输入卡片、新增推荐场景 chips、优化侧边栏状态与对比度；第二轮针对细节硬伤做精修——清理输入框残留、Hero Logo 透明化、"新对话"Active 柔光环+脉冲、Chips 卡片化、文件提示位置调整、Aurora 氛围光晕、侧边栏 logo 与按钮对齐。
